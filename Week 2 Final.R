...
#!!!!!!!!!!!!!!!!!!!!! IF YOU DON'T HAVE GEOHASH LIBRARY, MAKE SURE data_bg_final.RDS IS IN YOUR WD
#geohash_decoded <- as.data.frame(gh_decode(summary$geohash))
geohash_decoded<-readRDS("./geohash_decoded.RDS")
...
data_bg_final<-readRDS("./data_bg_final.RDS")
...
sum(is.na(z4))#[1] 1 928 965 # Kiril: 1 830 150
...
length(geo_units) # [1] 116 # Kiril: 113
