...
division_date<-ymd_hms("2018-09-13 22:00:00") # set 24 hours for validation of the model
...
for (i in 1:length(test_list)){
  ...
  comparison[[i]] <- as.numeric(mean(results[[i]][[1]])) / as.numeric(lapply(test_list[[i]]["P1"], mean)) * 100
